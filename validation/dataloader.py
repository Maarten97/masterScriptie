...
def inspect_dataset_with_descriptors(dataset, descriptor_file_path):
    """
...
if __name__ == '__main__':
    ...
    # dataset = load_dataset('coastalcph/multi_eurlex', 'nl', split='validation', trust_remote_code=True)

    # Inspect dataset and display EUROVOC descriptors
    # inspect_dataset_with_descriptors(dataset, './eurovoc_descriptors.json')
